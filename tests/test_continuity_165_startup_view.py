...
class TestStartupView(unittest.TestCase):
    ...
    def test_startup_summary_key_order(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as td:
            ...
            ss = out["startup_summary"]
            self.assertEqual(list(ss.keys()), ["recovery", "orientation", "context", "updated_at", "trust_signals", "stable_preferences"])
            self.assertEqual(
    ...
    def test_build_startup_summary_pure_and_deterministic(self) -> None:
        ...
        # Verify key order
        self.assertEqual(list(result1.keys()), ["recovery", "orientation", "context", "updated_at", "trust_signals", "stable_preferences"])
