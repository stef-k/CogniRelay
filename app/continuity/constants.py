...
CONTINUITY_CAPSULE_SCHEMA_VERSION = "1.1"
CONTINUITY_SUPPORTED_CAPSULE_SCHEMA_VERSIONS = frozenset({"1.0", CONTINUITY_CAPSULE_SCHEMA_VERSION})
CONTINUITY_FALLBACK_SCHEMA_TYPE = "continuity_fallback_snapshot"
CONTINUITY_FALLBACK_SCHEMA_VERSION = "1.1"
CONTINUITY_SUPPORTED_FALLBACK_SCHEMA_VERSIONS = frozenset({"1.0", CONTINUITY_FALLBACK_SCHEMA_VERSION})
CONTINUITY_ARCHIVE_SCHEMA_TYPE = "continuity_archive_envelope"
CONTINUITY_ARCHIVE_SCHEMA_VERSION = "1.1"
CONTINUITY_SUPPORTED_ARCHIVE_SCHEMA_VERSIONS = frozenset({"1.0", CONTINUITY_ARCHIVE_SCHEMA_VERSION})
CONTINUITY_COLD_STUB_SCHEMA_TYPE = "continuity_cold_stub"
CONTINUITY_COLD_STUB_SCHEMA_VERSION = "1.1"
CONTINUITY_SUPPORTED_COLD_STUB_SCHEMA_VERSIONS = frozenset({"1.0", CONTINUITY_COLD_STUB_SCHEMA_VERSION})
